...
@everywhere begin
    ...
    CTS_like = false
    debug = false
    detector_location = [0.0, 0.0, 0.0] # TOFOR (proxy): [2.97, 0.0, 18.8] /// NE213 (proxy): [8.35,2.1,-0.27]. When coordinate_system==:magrel, detector_location can be set to whatever (the script will figure it out automatically from the angle and LOS_length)
