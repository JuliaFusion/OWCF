...
@everywhere begin
    analytic = false
    debug = false
    diagnostic_filepath = folderpath_OWCF*"vc_data$(folder_delimiter)TOFOR$(folder_delimiter)TOFOR.vc" # Currently supported: "TOFOR", "AB" and ""
    diagnostic_name = "TOFOR"
    instrumental_response_filepath = folderpath_OWCF*"vc_data$(folder_delimiter)TOFOR$(folder_delimiter)TOFOR_instrumental_response.jld2" # Should be the filepath to three .txt-files or one .jld2-file. Otherwise, leave as ""
