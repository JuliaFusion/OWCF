...
@everywhere begin
    ...
    folderpath_out = folderpath_OWCF*"tests/outputs/" # The output folder in which to save the custom fast-ion distribution data
    max_E = 150.0 # keV
    ...
    elseif distribution_type==:collisional
        ...
        filepath_equil = folderpath_OWCF*"equilibrium/JET/g96100/g96100_0-53.0012.eqdsk" # E.g. "g94701_0-50.7932.eqdsk" or "solovev_equilibrium_2024-09-30.jld2"
