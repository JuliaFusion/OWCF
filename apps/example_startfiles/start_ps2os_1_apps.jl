...
@everywhere begin
    ...
    filepath_EpRz = "/home/henrikj/Data/JET/99971/TRANSP/L72/99971L72_fi_2.jld2" # For example "c12_2_FI_distribution_800x50x43x49(+1).h5" or "c15_3_FI_distribution_101x52x45x47.jld2" or "EpRzTopoMap_JET_99965K73_at48,4058s_D_100x50x51x54_wLost_wJac.jld2"
    ...
    filepath_W = ""
    filepath_OG = "apps/example_data/orbGrid_JET_99971L71_at48,9s_D_6x101x102.jld2"
    folderpath_o = "apps/example_data/" # Output folder path. Finish with '/'
    ...
    TRANSP_id = "99971L72" # If unknown, leave as ""
