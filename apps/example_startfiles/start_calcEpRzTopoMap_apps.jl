...
@everywhere begin
    ...
    plot_results = true # Set to true, if (a selection of) the results are to be plotted and saved upon completion of the computations
    ...
    # toa stands for "try only adaptive" integration scheme
end
