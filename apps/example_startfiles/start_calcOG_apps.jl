...
@everywhere begin
    ...
    filepath_equil = "$(folderpath_OWCF)equilibrium/JET/g99971/g99971_474-48.9.eqdsk" #for example "equilibrium/JET/g96100/g96100_0-53.0012.eqdsk" Do NOT finish with '/', it's a file.
    folderpath_o = "$(folderpath_OWCF)apps/example_data/" # Output folder path. Finish with '/', it's a folder.
    ...
    tokamak = "JET" # You could specify the tokamak, if you know it. Please note, it's only for esthetic purposes
    TRANSP_id = "99971L71" # You could specify the TRANSP ID, if you know it. Please note, it's only for esthetic purposes
    ...
    E_array = [5.0, 50.0, 150.0, 250.0, 500.0, 1000.0] # keV. Array can be specified manually. Otherwise, leave as 'nothing'
