...
@everywhere begin
    ...
    addNoise = true # If true, then the algorithm will automatically add noiseLevel % noise to your synthetic diagnostic signal
    ...
    visualizeProgress = true # If set to true, a progress bar will be displayed during distributed computation
