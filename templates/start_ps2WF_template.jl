...
@everywhere begin
    ...
    filepath_FI_TRANSP_shot = "" # As an example, if filepath_thermal_distr=="96100J01.cdf" then this variable can be "96100J01_fi_1.cdf".
    ...
    inclPrideRockOrbs = false # If true, then (drift) orbits with pm<R_axis will be included
