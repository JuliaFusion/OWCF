...
@everywhere begin
    ...
    Ed_min = 0000.0 # keV (or m/s if 'reaction' input variable is on form (3))
    Ed_max = 0000.0 # keV (or m/s if 'reaction' input variable is on form (3))
    Ed_diff = 00.0 # keV (or m/s if 'reaction' input variable is on form (3))
